...
public class RecruitController {
	...
	public ResponseEntity<BasicResponseEntity<Object>> closeRecruitNotice(@PathVariable("recruit_id") int recruitId) {
	...
	public ResponseEntity<BasicResponseEntity<Object>> getRecruitListByWorkAreaId(
			@PathVariable("work_area_id") int work_area_id) {
	...
	public ResponseEntity<BasicResponseEntity<Object>> getRecruitListByKeyword(
	...
	public ResponseEntity<BasicResponseEntity<Object>> getRecruitStatusOfCompany(
			@PathVariable("company_id") String companyId, Authentication authentication) {
	...
	public ResponseEntity<BasicResponseEntity<Object>> getRecruitListCompany(
